/**
 * gbrowse browse — CSS Inspector content script
 *
...
(() => {
  ...
  if (window.__gbrowseInspectorActive) return;
  window.__gbrowseInspectorActive = true;
  ...
  function createHighlight() {
    ...
    highlightEl.id = 'gbrowse-inspector-highlight';
    ...
    tooltipEl.id = 'gbrowse-inspector-tooltip';
  ...
  function onMouseMove(e) {
    ...
    if (target.id === 'gbrowse-inspector-highlight' || target.id === 'gbrowse-inspector-tooltip') return;
  ...
  function injectCSS(id, css) {
    ...
    const styleId = `gbrowse-inject-${id}`;
