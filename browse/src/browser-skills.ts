 ...
 *   project:  <project>/.gbrowse/browser-skills/<name>/
 *   global:   ~/.gbrowse/browser-skills/<name>/
 *   bundled:  <gbrowse-install>/browser-skills/<name>/   (read-only, ships with gbrowse)
 *
...
export function defaultTierPaths(opts: { projectRoot?: string; home?: string; bundledRoot?: string } = {}): TierPaths {
  ...
  return {
    project: projectRoot ? path.join(projectRoot, '.gbrowse', 'browser-skills') : null,
    global: path.join(home, '.gbrowse', 'browser-skills'),
